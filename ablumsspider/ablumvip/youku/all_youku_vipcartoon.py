...
class all_youku_vipcartoon():
    def __init__(self):
        print "Do spider all_youku_vipcartoon."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.youku.com/category/show/c_100_pt_2_s_6_d_1_p_1.html"
                         , "http://list.youku.com/category/show/c_100_pt_2_s_6_d_1_p_1.html"
                         , "http://list.youku.com/category/show/c_100_pt_2_s_6_d_1_p_2.html"
                         , "http://list.youku.com/category/show/c_100_pt_2_s_6_d_1_p_3.html"
                         , "http://list.youku.com/category/show/c_100_pt_2_s_6_d_1_p_4.html"
                         , "http://list.youku.com/category/show/c_100_pt_2_s_6_d_1_p_5.html"
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.seqNocnt = 1
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_youku_vipcartoon_" + self.today + ".txt")
