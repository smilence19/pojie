...
class all_youku_vipreal():
    def __init__(self):
        print "Do spider all_youku_vipreal."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.youku.com/category/show/c_84_pt_2_s_6_d_1_p_1.html"
                         , "http://list.youku.com/category/show/c_84_pt_2_s_6_d_1_p_1.html"
                         , "http://list.youku.com/category/show/c_84_pt_2_s_6_d_1_p_2.html"
                         , "http://list.youku.com/category/show/c_84_pt_2_s_6_d_1_p_3.html"
                         , "http://list.youku.com/category/show/c_84_pt_2_s_6_d_1_p_4.html"
                         , "http://list.youku.com/category/show/c_84_pt_2_s_6_d_1_p_5.html"
                         ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.seqNocnt = 1
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_youku_vipreal_" + self.today + ".txt")
    ...
    def secondSpider(self, seed_sub):
        ...
        for li in sub_soup.find_all('li'):
            ...
            if self.program['shootYear'] != "" and re.search(r'^\d{2}-\d{2}期$'.decode('utf8'), setNumber):
                ...
                setNumber = re.search(r'\d+'.decode('utf8'), setNumber).group(1)
            ...
            elif re.search(r'第(\d+)集'.decode('utf8'), setNumber):
                setNumber = re.search(r'第(\d+)集'.decode('utf8'), setNumber).group(1)
