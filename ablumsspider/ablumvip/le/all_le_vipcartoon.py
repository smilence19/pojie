...
class all_le_vipcartoon():
    def __init__(self):
        print "Do spider all_le_vipcartoon."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://api.vip.le.com/search/interface?sales_area=cn&user_setting_country=cn&cg=5&ph=420001&pt=141001&dt=1&src=1&ispay=1&stype=1&lang=zh_cn&stt=1&ps=60&pn=1&lh=0&vt=&sc=&ar=&ag=&or=6&eid=10397897202250023767"
                         , "http://api.vip.le.com/search/interface?sales_area=cn&user_setting_country=cn&cg=5&ph=420001&pt=141001&dt=1&src=1&ispay=1&stype=1&lang=zh_cn&stt=1&ps=60&pn=1&lh=0&vt=&sc=&ar=&ag=&or=6&eid=10397897202250023767"
                        ]
        self.seedList = []
        self.images = {}
        ...
        self.seqNocnt = 1
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_le_vipcartoon_" + self.today + ".txt")
