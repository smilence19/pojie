...
class all_qq_children():
    def __init__(self):
        print "Do spider all_qq_children."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://v.qq.com/x/childrenlist/?sort=5&offset=0"
                         , "http://v.qq.com/x/childrenlist/?sort=5&offset=0"
                         , "https://v.qq.com/x/childrenlist/?sort=5&offset=20"
                         , "https://v.qq.com/x/childrenlist/?sort=5&offset=40"
                         , "https://v.qq.com/x/childrenlist/?sort=5&offset=60"
                         , "https://v.qq.com/x/childrenlist/?sort=5&offset=80"
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_qq_children_" + self.today + ".txt")
