...
class all_mfsp_variety():
    def __init__(self):
        print "Do spider all_mfsp_variety."
        ...
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_mfsp_variety_" + self.today + ".txt")
    ...
    def doProcess(self):
        for i in range(1, 2):
            self.seedBase.append("http://www.beevideo.tv/api/video2.0/video_list.action?pageNo=" + str(i) + "&pageSize=50&channelId=4")
