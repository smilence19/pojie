...
class all_le_children():
    def __init__(self):
        print "Do spider all_le_children."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = [ "http://list.le.com/apin/chandata.json?a=50041&c=5&d=1&f=511001&md=&o=20&p=1&s=1" #0-6
        ...
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_le_children_" + self.today + ".txt")
