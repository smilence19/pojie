...
class all_mgtv_children():
    def __init__(self):
        print "Do spider all_mgtv_children."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.mgtv.com/50/---2834812------2-1-0--.html" #0-3
                         , "http://list.mgtv.com/50/---2834812------2-1-0--.html" #0-3
                         , "http://list.mgtv.com/50/---2834812------2-2-0--.html" #0-3
                         , "http://list.mgtv.com/50/---2834812------2-3-0--.html" #0-3
                         , "http://list.mgtv.com/50/---2834813------2-1-0--.html" #4-6
                         , "http://list.mgtv.com/50/---2834813------2-2-0--.html" #4-6
                         , "http://list.mgtv.com/50/---2834813------2-3-0--.html" #4-6
                         , "http://list.mgtv.com/50/---2835743------2-1-0--.html" #7-10
                         , "http://list.mgtv.com/50/---2835743------2-2-0--.html" #7-10
                         , "http://list.mgtv.com/50/---2835743------2-3-0--.html" #7-10
                         , "http://list.mgtv.com/50/---2835766------2-1-0--.html" #11-14
                         , "http://list.mgtv.com/50/---2835766------2-2-0--.html" #11-14
                         , "http://list.mgtv.com/50/---2835933------2-1-0--.html" #15-18
                         , "http://list.mgtv.com/50/---2835933------2-2-0--.html" #15-18
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.prgdata = {}
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_mgtv_children_" + self.today + ".txt")
