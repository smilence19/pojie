...
class amuse_iqiyi_1():
    def __init__(self):
        print "Do spider amuse_iqiyi_1."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.iqiyi.com/www/7/-------------4-1-2-iqiyi-1-.html",
                         "http://list.iqiyi.com/www/7/-------------4-1-2-iqiyi-1-.html",
                         "http://list.iqiyi.com/www/7/-------------4-2-2-iqiyi-1-.html",
                         "http://list.iqiyi.com/www/7/-------------4-3-2-iqiyi-1-.html",
                         "http://list.iqiyi.com/www/7/-------------4-4-2-iqiyi-1-.html",
                         "http://list.iqiyi.com/www/7/-------------4-5-2-iqiyi-1-.html",
                         "http://list.iqiyi.com/www/7/-------------4-6-2-iqiyi-1-.html",
        ]
        self.pidList = {}
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "amuse_iqiyi_1_" + self.today + ".txt")
