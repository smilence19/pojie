...
class news_youku_1():
    def __init__(self):
        print "Do spider news_youku_1."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.youku.com/category/video/c_91_d_1_s_2_p_1.html",
                         "http://list.youku.com/category/video/c_91_d_1_s_2_p_1.html",
                         "http://list.youku.com/category/video/c_91_d_1_s_2_p_2.html",
                         "http://list.youku.com/category/video/c_91_d_1_s_2_p_3.html",
                         "http://list.youku.com/category/video/c_91_d_1_s_2_p_4.html",
                         "http://list.youku.com/category/video/c_91_d_1_s_2_p_5.html",
                         "http://list.youku.com/category/video/c_91_d_1_s_2_p_6.html",

        ]
        self.pidList = {}
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "news_youku_1_" + self.today + ".txt")
