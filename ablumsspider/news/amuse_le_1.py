...
class amuse_le_1():
    def __init__(self):
        print "Do spider amuse_le_1."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=1",
                         "http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=1",
                         "http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=2",
                         "http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=3",
                         "http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=4",
                         "http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=5",
                         "http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=6",
                         "http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=7",
                         "http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=8",
                         "http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=9",
                         "http://list.le.com/apin/chandata.json?c=3&d=2&md=&o=1&p=10",
        ]
        self.pidList = {}
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "amuse_le_1_" + self.today + ".txt")
