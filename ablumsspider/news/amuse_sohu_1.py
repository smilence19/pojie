...
class amuse_sohu_1():
    def __init__(self):
        print "Do spider amuse_sohu_1."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://so.tv.sohu.com/list_p1112_p2_p3_p486400_p5_p6_p7_p8_p9_p10_p11_p12_p13.html",
                         "http://so.tv.sohu.com/list_p1112_p2_p3_p486400_p5_p6_p7_p8_p9_p10_p11_p12_p13.html",
                         "http://so.tv.sohu.com/list_p1112_p2_p3_p486400_p5_p6_p7_p8_p9_p102_p11_p12_p13.html",
        ]
        self.pidList = {}
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "amuse_sohu_1_" + self.today + ".txt")
