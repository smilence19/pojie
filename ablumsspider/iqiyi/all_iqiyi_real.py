...
class all_iqiyi_real():
    def __init__(self):
        print "Do spider all_iqiyi_real."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = copy.deepcopy(PROGRAM_SUB)
        self.seedBase = ["http://list.iqiyi.com/www/3/-------------11-1--iqiyi-1-.html",
                         "http://list.iqiyi.com/www/3/-------------11-2--iqiyi-1-.html",
                         "http://list.iqiyi.com/www/3/-------------11-3--iqiyi-1-.html",
                         "http://list.iqiyi.com/www/3/-------------11-4--iqiyi-1-.html",
                         "http://list.iqiyi.com/www/3/-------------11-5--iqiyi-1-.html",
                         "http://list.iqiyi.com/www/3/-------------11-6--iqiyi-1-.html",
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_iqiyi_real_" + self.today + ".txt")
