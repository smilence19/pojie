...
class iqiyi_variety_2():
    def __init__(self):
        print "Do spider iqiyi_variety_2."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = copy.deepcopy(PROGRAM_SUB)
        self.seedList = ['http://www.iqiyi.com/a_19rrgublqh.html#vfrm=2-3-0-1'
,'http://www.iqiyi.com/a_19rrgublqh.html#vfrm=2-3-0-1'#爱情保卫战
,'http://www.iqiyi.com/a_19rrguaab9.html#vfrm=2-3-0-1'#经典传奇
,'http://www.iqiyi.com/a_19rrgu9owx.html#vfrm=2-3-0-1'#娱乐猛回头
,'http://www.iqiyi.com/a_19rrguabs9.html#vfrm=2-3-0-1'#一站到底（2016）
,'http://www.iqiyi.com/a_19rrha9c9d.html#vfrm=2-3-0-1'#二十四小时
        ]
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "iqiyi_variety_2_" + self.today + ".txt")
