...
class youku_short_3():
    def __init__(self):
        print "Do spider youku_short_3."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedList = ['http://list.youku.com/show/id_z75312caa2c8711e6b432.html'
,'http://list.youku.com/show/id_zee39f2fcefde11e5a080.html'#星座萌萌哒
,'http://list.youku.com/show/id_zf6188b028f3d11e5b2ad.html'#段富超系列作品 2016
,'http://list.youku.com/show/id_zdcb12d08aa0011e0a046.html'#果果乐园
,'http://list.youku.com/show/id_z2ee3074032d711e69e2a.html'#电影纵贯线第二季

        ]
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "youku_short_3_" + self.today + ".txt")
