...
class all_ppypp_movie():
    def __init__(self):
        ...
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_ppypp_movie_" + self.today + ".txt")
    ...
    def seedSpider(self):
        for seed in self.seedList:
            ...
            if self.program['name'] == '' or self.program['name'] is None \
                ...
                continue
            if re.search(r'(微电影)'.decode('utf8'), self.program['name']):
                self.program["ptype"] = "微电影".decode("utf8")
                print self.program['name'], self.program['totalSets'],"微电影"
    ...
    def firstSpider(self, seed):
        ...
        if re.match(r'http://www.ppypp.com/dy/(\w+)/', seed):
            mainId = "ppypp_dy_" + re.match(r'http://www.ppypp.com/dy/(\w+)/', seed).group(1)
    ...
    def secondSpider(self):
            ...
            self.program_sub['webUrl'] = self.program['pcUrl'] + 'play-0-0.html'
