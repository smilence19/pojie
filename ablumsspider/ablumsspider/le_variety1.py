...
class le_variety_1():
    def __init__(self):
        print "Do spider le_variety_1."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedList = ['http://www.le.com/zongyi/6142.html'
                        ,'http://www.le.com/zongyi/6142.html'#时尚美妆
                        ,'http://www.le.com/zongyi/87261.html'#选择
                        ,'http://www.le.com/zongyi/10024275.html'#奶奶说
                        ,'http://www.le.com/zongyi/10007690.html'#让我帮助你
                        ,'http://www.le.com/zongyi/10024835.html'#勇者大冲关
                        ,'http://www.le.com/zongyi/90307.html'#大声说出了（2016）
                        ,'http://www.le.com/zongyi/10024487.html'#车神驾到
                        ,'http://www.le.com/zongyi/10023759.html'#说出我的世界
                        ,'http://www.le.com/zongyi/10010362.html'#幸福的味道
                        ,'http://www.le.com/zongyi/10007741.html'#最强大夫
                        ,'http://www.le.com/zongyi/10008928.html'#最佳选择
                        ,'http://www.le.com/zongyi/10023736.html'#英雄传奇
                        ,'http://www.le.com/zongyi/78743.html'#今天我当家
                        ,'http://www.le.com/zongyi/87206.html'#华豫之门（2016）
                        ,'http://www.le.com/zongyi/10020171.html'#欢乐版米粒儿
                        ,'http://www.le.com/zongyi/10020456.html'#全员加热中
                        ,'http://www.le.com/zongyi/75538.html'#东方直播室
            ]
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "le_variety_1_" + self.today + ".txt")
    ...
    def firstSpider(self, seed):
        ...
        pid = ""
        if re.search(r'http://www\.le\.com/zongyi/(?P<pid>\d+)\.html',seed):
                pid = re.search(r'http://www\.le\.com/zongyi/(?P<pid>\d+)\.html',seed).group('pid')
        if pid != '' or pid != '0':
