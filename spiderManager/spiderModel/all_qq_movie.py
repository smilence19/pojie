...
class all_qq_movie():
    def __init__(self):
        print "Do spider all_qq_movie."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["https://v.qq.com/x/movielist/?cate=10001&offset=0&sort=5",
                         "https://v.qq.com/x/movielist/?cate=10001&offset=0&sort=5",
                         "https://v.qq.com/x/movielist/?cate=10001&offset=20&sort=5",
                         "https://v.qq.com/x/movielist/?cate=10001&offset=40&sort=5"
                         "https://v.qq.com/x/movielist/?cate=10001&offset=60&sort=5",
                         "https://v.qq.com/x/movielist/?cate=10001&offset=80&sort=5",
                         "https://v.qq.com/x/movielist/?cate=10001&offset=100&sort=5"
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_qq_movie_" + self.today + ".txt")
    #
    # def __del__(self):
