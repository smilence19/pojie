...
class all_mfsp_movie():
    def __init__(self):
        print "Do spider all_mfsp_movie."
        ...
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_mfsp_movie_" + self.today + ".txt")
    #
    # def __del__(self):
    ...
    def doProcess(self):
        for i in range(1, 2):
            self.seedBase.append("http://www.beevideo.tv/api/video2.0/video_list.action?pageNo=" + str(i) + "&pageSize=50&channelId=1")
