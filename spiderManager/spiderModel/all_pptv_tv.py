...
class all_pptv_tv():
    def __init__(self):
        print "Do spider all_pptv_tv."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.pptv.com/channel_list.html?type=2&page=1",
                         "http://list.pptv.com/channel_list.html?type=2&page=1",
                         "http://list.pptv.com/channel_list.html?type=2&page=2",
                         "http://list.pptv.com/channel_list.html?type=2&page=3",
                         "http://list.pptv.com/channel_list.html?type=2&page=4",
                         "http://list.pptv.com/channel_list.html?type=2&page=5",
                         "http://list.pptv.com/channel_list.html?type=2&page=6",
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_pptv_tv_" + self.today + ".txt")
    #
    # def __del__(self):
