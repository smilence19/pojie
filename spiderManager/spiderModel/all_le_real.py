...
class all_le_real():
    def __init__(self):
        print "Do spider all_le_real."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.le.com/apin/chandata.json?c=16&d=2&md=&o=1&p=1",
                         "http://list.le.com/apin/chandata.json?c=16&d=2&md=&o=1&p=1",
                         "http://list.le.com/apin/chandata.json?c=16&d=2&md=&o=1&p=2",
                         "http://list.le.com/apin/chandata.json?c=16&d=2&md=&o=1&p=3",
                         "http://list.le.com/apin/chandata.json?c=16&d=2&md=&o=1&p=4",
                         "http://list.le.com/apin/chandata.json?c=16&d=2&md=&o=1&p=5",
                         "http://list.le.com/apin/chandata.json?c=16&d=2&md=&o=1&p=6",
        ]
        self.seedList = []
        self.images = {}
        ...
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_le_real_" + self.today + ".txt")
    #
    # def __del__(self):
