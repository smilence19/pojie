...
class all_mgtv_cartoon():
    def __init__(self):
        print "Do spider all_mgtv_cartoon."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.mgtv.com/50/---2835934------2-1-0--.html"
                         , "http://list.mgtv.com/50/---2835934------2-1-0--.html"
                         , "http://list.mgtv.com/50/---2835934------2-2-0--.html"
                         , "http://list.mgtv.com/50/---2835934------2-3-0--.html"
        ]
        self.seedList = []
        ...
        self.prgdata = {}
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_mgtv_cartoon_" + self.today + ".txt")
    #
    # def __del__(self):
