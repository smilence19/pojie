...
class all_youku_cartoon():
    def __init__(self):
        print "Do spider all_youku_cartoon."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.youku.com/category/show/c_100_s_1_d_1_p_1.html",
                         "http://list.youku.com/category/show/c_100_s_1_d_1_p_2.html",
                         "http://list.youku.com/category/show/c_100_s_1_d_1_p_3.html",
                         "http://list.youku.com/category/show/c_100_s_1_d_1_p_4.html",
                         "http://list.youku.com/category/show/c_100_s_1_d_1_p_5.html"
        ]
        self.seedList = []
        ...
        if p_base_content is not None:
            for li in p_base_content.find_all('li'):
                ...
                if li.find('span', attrs={'class': 'star-num'}) is not None:
                    ...
                    name_p = li.get_text()
                    name_p = re.findall(r'：(.*)\s*\d*'.decode('utf8'), name_p)
                    if name_p:
                        name = name_p[0]
