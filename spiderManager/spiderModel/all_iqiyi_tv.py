...
class all_iqiyi_tv():
    def __init__(self):
        print "Do spider all_iqiyi_tv."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.iqiyi.com/www/2/-------------4-1-1-iqiyi--.html",
                         "http://list.iqiyi.com/www/2/-------------4-2-1-iqiyi--.html",
                         "http://list.iqiyi.com/www/2/-------------4-3-1-iqiyi--.html",
                         "http://list.iqiyi.com/www/2/-------------4-4-1-iqiyi--.html",
                         "http://list.iqiyi.com/www/2/-------------4-5-1-iqiyi--.html",
                         "http://list.iqiyi.com/www/2/-------------4-6-1-iqiyi--.html",
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_iqiyi_tv_" + self.today + ".txt")
    #
    # def __del__(self):
