...
class all_pptv_movie():
    def __init__(self):
        print "Do spider all_pptv_movie."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.pptv.com/channel_list.html?type=1&page=1",
                         "http://list.pptv.com/channel_list.html?type=1&page=1",
                         "http://list.pptv.com/channel_list.html?type=1&page=2",
                         "http://list.pptv.com/channel_list.html?type=1&page=3",
                         "http://list.pptv.com/channel_list.html?type=1&page=4",
                         "http://list.pptv.com/channel_list.html?type=1&page=5",
                         "http://list.pptv.com/channel_list.html?type=1&page=6",
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_pptv_movie_" + self.today + ".txt")
    #
    # def __del__(self):
    ...
    def firstSpider(self, seed):
        ...
        if id_P:
            id = id_P.group('id')
            seedData = 'http://svcdn.pptv.com/show/v1/meta.json?cid=%s&sid=%s&psize=50' % (id, pid)
            mainId="dianying" + id
        elif id_P1:
            id = id_P1.group('id')
            mainId="dianying" + id
    ...
    def secondSpider(self, seed, name):
