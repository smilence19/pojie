...
class all_iqiyi_cartoon():
    def __init__(self):
        print "Do spider all_iqiyi_cartoon."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.iqiyi.com/www/4/-------------11-1-1-iqiyi--.html",
                         "http://list.iqiyi.com/www/4/-------------11-2-1-iqiyi--.html",
                         "http://list.iqiyi.com/www/4/-------------11-3-1-iqiyi--.html",
                         "http://list.iqiyi.com/www/4/-------------11-4-1-iqiyi--.html",
                         "http://list.iqiyi.com/www/4/-------------11-5-1-iqiyi--.html",
                         "http://list.iqiyi.com/www/4/-------------11-6-1-iqiyi--.html",
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_iqiyi_cartoon_" + self.today + ".txt")
    #
    # def __del__(self):
