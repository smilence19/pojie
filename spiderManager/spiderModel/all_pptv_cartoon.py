...
class all_pptv_cartoon():
    def __init__(self):
        print "Do spider all_pptv_cartoon."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://list.pptv.com/channel_list.html?type=3&page=1",
                         "http://list.pptv.com/channel_list.html?type=3&page=1"
                         "http://list.pptv.com/channel_list.html?type=3&page=2"
                         "http://list.pptv.com/channel_list.html?type=3&page=3"
                         "http://list.pptv.com/channel_list.html?type=3&page=4"
                         "http://list.pptv.com/channel_list.html?type=3&page=5"
                         "http://list.pptv.com/channel_list.html?type=3&page=6"
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_pptv_cartoon_" + self.today + ".txt")
    #
    # def __del__(self):
