...
class FacebookSearchSpider(InitSpider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._task = None
        self.keywords = 'CGTNFrancais'
        self.__current_job = None

        self.login_user = "huangqingjunqwe@126.com"
        self.login_pass = "flying555$"
        self.facebook_account_id = "100022221132390"
        self.fb_api_req_access_token = "EAARDVcuRmWMBAIrdA6OoVDZCqh4LZBpfZAIrdoZCe1D9EMcmRWgi4AVz24ruWIr8laNTw9rP6kFHlaBPWBGTjo4BWUZC2nIF7AKFr2t4ZB17qSvb4UbTt4E8QfkprCafPuP2g7CA5UHkdswBNZACQ2t1wQ1JZCBjqfAZD"
    ...
    def after_login(self, response):
        # check login
        print(response.text)
        if self.facebook_account_id not in response.text:
            self.logger.error("Failed to login, close spider, check facebook account.")
        # cancel every task to login
        else:
            return self.make_requests_from_job(self.keywords,100,100,self.fb_api_req_access_token)
